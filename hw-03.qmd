...
#This plot is similar to question 3 however despite much difficulty I could not flip the responses to the top and the explanatory to the right side to better visualize the error bars unfortunately. These error bars at 25% and 75% highlight better the diversity in responses, whereas the 90-10%-iles took up most of the plots, not allowing for the diversity by gender, ethnicity and those who are not vaccinated. 
...
#chatGPT : after several hours and continuous errors in the code, I attempted to correct the errors in the ggplot and to re-orient the plot, without success
